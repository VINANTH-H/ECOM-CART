...
✅ Product Listing — Displays 5–10 mock products (id, name, price, image).

✅ Add to Cart — Add items with specified quantity to the shopping cart.

✅ View Cart — View cart items with name, quantity, and price details.

✅ Update/Remove Items — Modify or delete items directly from the cart.

✅ Checkout Flow — Fill name and email → Generate mock receipt (with total & timestamp).

✅ MongoDB Integration — Product and cart data stored and retrieved from MongoDB.

✅ Responsive UI — Styled with an H&M-like theme for a clean, minimal layout.

🛍️ Product Grid (Home Page)
